<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="demo.aspx.cs" Inherits="TreeDemo.demo" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.getJSON("api/tree/gettypes", function (data) {

                $.jstree.defaults.types = data;
            ...
            //$.jstree.defaults.types = { "#": { "valid_children": [] }, "1": { "valid_children": ["2", "3"] }, "2": { "valid_children": ["5"] }, "3": { "valid_children": ["4"] }, "4": { "valid_children": [] }, "5": { "valid_children": [] } };
